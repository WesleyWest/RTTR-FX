...
CREATE TABLE `users` (
  ...
  UNIQUE KEY `name_UNIQUE` (`user_name`) /*!80000 INVISIBLE */,
  KEY `role_key_idx` (`user_role`),
  CONSTRAINT `role_key` FOREIGN KEY (`user_role`) REFERENCES `roles` (`role_code`)
...
-- Dump completed on 2019-10-23 17:40:33
